...
const reserve =async (req, res) => {
  try {
    ...
    'Reservation Confirmation',
     `Dear ${email.split('@')[0]}
You have successfully reserved the hour of day ${DateTime.fromISO(selectedHour).toLocaleString(DateTime.DATE_SHORT)},
The time is ${DateTime.fromISO(selectedHour).minus({ hours: 2 }).toLocaleString(DateTime.TIME_24_SIMPLE)}
And we happy to use our website 
Think You .`);
